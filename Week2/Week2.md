...
void GetTime1()
{
    ...
    auto uptime = chrono::milliseconds(GetTickCount());
...
{
    long count = 0;
    wcout << count << L" Hotfix(s) Installed." << endl;
}
void NetworkCardCountKey()
{
    long count = 0;
    wcout << count << L" NIC(s) Installed." << endl;
}
...
int main()
{
    ...
    LPSTR SysDir;
    GetSystemDirectoryA(SysDir, 100);
    ...
    wcout << left << setw(40) << "Hotfix(s): ";
    HotfixCountKey();
    wcout << left << setw(40) << "Network Card(s): ";
    NetworkCardCountKey();
    free(Computername);
    free(ProductName);
